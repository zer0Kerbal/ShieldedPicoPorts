...
* "KerGuise Engineering eXperimental" is a trademark of zer0Kerbal
* KGEx is a trademark of zer0Kerbal
* KGX is a trademark of zer0Kerbal
...
## KerGuise Engineering eXperimental (KGEx) (KGX)

* "KerGuise Engineering eXperimental (KGEx) (KGX)" is a fictitious entity created for entertainment purposes. It is in no way meant to represent a real entity. Any similarity to a real entity is purely coincidental.
